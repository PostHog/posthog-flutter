...
abstract class PositionCalculator {
  double calculateLeftPosition(
      AlignmentGeometry alignment, Offset offset, double containerWidth, double renderBoxWidth);

  double calculateTopPosition(
      AlignmentGeometry alignment, Offset offset, double containerHeight, double renderBoxHeight);
}
