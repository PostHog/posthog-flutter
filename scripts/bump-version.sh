...
perl -pi -e "s/postHogFlutterVersion = \".*\"/postHogFlutterVersion = \"$NEW_VERSION\"/" posthog_flutter/darwin/posthog_flutter/Sources/posthog_flutter/PostHogFlutterVersion.swift
